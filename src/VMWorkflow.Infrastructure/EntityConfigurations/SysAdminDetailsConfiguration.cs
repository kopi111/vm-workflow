...
public class SysAdminDetailsConfiguration : IEntityTypeConfiguration<SysAdminDetails>
{
    public void Configure(EntityTypeBuilder<SysAdminDetails> builder)
    {
        ...
        builder.Property(s => s.SensitivityLevel).IsRequired().HasMaxLength(30);
        ...
        builder.Property(s => s.DatabaseName).HasMaxLength(64);
        builder.Property(s => s.DatabaseUsername).HasMaxLength(64);
        builder.Property(s => s.Hostname).IsRequired().HasMaxLength(64);
